...
namespace FirmaTakip.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SKT = table.Column<string>(nullable: true),
                    CVVB = table.Column<string>(nullable: true),
                    CVVK = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyCategories_CategoryId_CompanyId",
                table: "CompanyCategories",
                columns: new[] { "CategoryId", "CompanyId" },
                unique: true);
        }
